...
<img src="/assets/img/prof_pic.jpg" class="profile img-fluid z-depth-1 rounded" alt="Profile picture" />Hi I am **Luis Oala**. I work on composable systems for measuring, optimizing and exchanging data states across the entire data generating life-cycle in machine learning. 
...
I am a big proponent, maintainer and user of open source machine learning infra. I co-initiated the ML metadata format [Croissant](https://github.com/mlcommons/croissant) now used by most of the big ML data hosters (Huggingface, Kaggle, Dataverse, and others), chair the industry working group Data at the [ITU](https://www.itu.int/en/Pages/default.aspx) to reduce transaction costs in data systems and support my friends at [OpenML]() as a core member.
...
A core thesis behind my work is that a lot of ML systems bottlenecks collapse into fast, granular access problems to the right data. That is also the premise behind [Brickroad](https://brickroad.network/), where I am building the data multiplexer as Co-Founder and CTO, a technology that lets you access frontier data at the rate of compute. I am also a final-year PhD research scientist at the [Department of Artificial Intelligence](https://www.hhi.fraunhofer.de/en/departments/ai.html) of [Wojciech Samek](http://iphome.hhi.de/samek/) at [Fraunhofer HHI](https://www.hhi.fraunhofer.de/en.html) in Berlin, Germany. Previously, I built [Dotphoton](https://dotphoton.com/) in Switzerland, data infrastructure for imaging machine learning workloads at petabyte scale.
...
* **2027.03.15** **\|** *Navigating the Data Frontier with the Data Multiplexer* **\|** **[[program]](https://shonan.nii.ac.jp/seminars/258/)** **\|** Invited Talk @ NII Shonan Meeting on Advancing Open Machine Learning **\|** *Hayama, Japan*
